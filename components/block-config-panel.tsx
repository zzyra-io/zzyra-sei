...
export function BlockConfigPanel({ node, onUpdate, onClose }: BlockConfigPanelProps) {
  ...
  const validateConfig = (config: any, nodeType: string) => {
    ...
    switch (nodeType) {
      case "price-monitor":
        ...
        if (!config.targetPrice || isNaN(Number.parseFloat(config.targetPrice))) {
  ...
  const handleSave = () => {
    ...
    const nodeType = node.type || node.data?.nodeType || node.data?.blockType || "unknown"
        ...
        return (
          <>
            <div className="space-y-2">
              ...
              <Select value={config.asset || "ETH"} onValueChange={(value) => handleConfigChange("asset", value)}>
              ...
              {validationErrors.asset && <p className="text-xs text-destructive mt-1">{validationErrors.asset}</p>}
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleConfigChange("targetPrice", e.target.value)}
                placeholder="2000"
                className={validationErrors.targetPrice ? "border-destructive" : ""}
              />
              {validationErrors.targetPrice && (
                <p className="text-xs text-destructive mt-1">{validationErrors.targetPrice}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {validationErrors.condition && (
                <p className="text-xs text-destructive mt-1">{validationErrors.condition}</p>
              )}
            </div>
          </>
        )
        ...
        return (
          <>
            <div className="space-y-2">
              ...
              />
              {validationErrors.to && <p className="text-xs text-destructive mt-1">{validationErrors.to}</p>}
            </div>
            <div className="space-y-2">
              ...
              />
              {validationErrors.subject && <p className="text-xs text-destructive mt-1">{validationErrors.subject}</p>}
            </div>
            <div className="space-y-2">
              ...
              />
              {validationErrors.body && <p className="text-xs text-destructive mt-1">{validationErrors.body}</p>}
              <p className="text-xs text-muted-foreground mt-2">
                You can use template variables like <code>{"{{currentPrice}}"}</code> to include dynamic data.
              </p>
            </div>
          </>
        )
        ...
        return (
          <>
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground mt-2">
                Use JavaScript expressions like <code>value &gt; 100</code> or <code>data.status === 'success'</code>
              </p>
            </div>
          </>
        )
        ...
        return (
          <>
            ...
            <div className="space-y-2">
              ...
              <Select value={config.unit || "minutes"} onValueChange={(value) => handleConfigChange("unit", value)}>
        ...
        return (
          <>
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground mt-2">
                Write JavaScript code to transform the input data. Use <code>return</code> to output the transformed
                data.
              </p>
            </div>
          </>
      ...
      default:
        return (
          <div className="py-4 text-center text-sm text-muted-foreground">
            ...
            <p className="mt-2">You can customize the general settings in the tabs above.</p>
          </div>
        )
    }
  }
    ...
    return (
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Select value={style.backgroundColor} onValueChange={(value) => handleStyleChange("backgroundColor", value)}>
        ...
        <div className="space-y-2">
          ...
          <Select value={style.borderColor} onValueChange={(value) => handleStyleChange("borderColor", value)}>
        ...
        <div className="space-y-2">
          ...
          <Select value={style.textColor} onValueChange={(value) => handleStyleChange("textColor", value)}>
        ...
        <div className="space-y-2">
          ...
          <Select value={style.accentColor} onValueChange={(value) => handleStyleChange("accentColor", value)}>
