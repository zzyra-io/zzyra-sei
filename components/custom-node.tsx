    ...
    return (
      <MotionDiv
        ...
        className={cn(
          ...
          style.borderColor,
          style.textColor,
          selected ? `ring-2 ring-${style.accentColor} shadow-md` : "",
        ...
        style={{
          ...
          height: data.height,
          boxShadow: selected
            ? "0 0 0 2px var(--ring), 0 4px 8px rgba(0,0,0,0.1)"
            : undefined,
        }}>
        <NodeResizer
          minWidth={180}
        ...
        <div
          className={cn(
            ...
            style.borderColor,
            `bg-${style.accentColor}/10`,
            selected && `bg-${style.accentColor}/20`
          )}>
          <div
            className={cn(
            ...
            {data.nodeType && (
              <Badge
                className={cn(
                  ...
                  data.nodeType === NodeCategory.TRIGGER &&
                    "bg-blue-50 text-blue-700 border-blue-200",
                  data.nodeType === NodeCategory.ACTION &&
                    "bg-green-50 text-green-700 border-green-200",
                  data.nodeType === NodeCategory.LOGIC &&
                    "bg-purple-50 text-purple-700 border-purple-200",
                  data.nodeType === NodeCategory.FINANCE &&
        ...
        <div className='p-3'>
          ...
          {!isEnabled && (
            <Badge className='bg-yellow-50 text-yellow-700 border-yellow-200 mt-2'>
              Disabled
            </Badge>
          )}
        </div>
