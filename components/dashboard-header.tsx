...
import { Database, Home, Settings, FileText, Layers, Zap, Wallet, Menu, X, Search, Bell } from "lucide-react"
              ...
              return (
                <li key={item.name}>
                  ...
                  >
                    ...
                    {item.name}
                    {item.badge && (
                      <Badge variant="default" className="ml-2 px-1.5 py-0.5 h-5">
                        {item.badge}
                      </Badge>
                    )}
                  </Link>
        ...
        <div className="ml-auto flex items-center space-x-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <div className="p-4 text-sm text-muted-foreground">You have no unread notifications.</div>
            </DropdownMenuContent>
          </DropdownMenu>
