...
export function NotificationLogsTable() {
  ...
  const getNotificationTypeLabel = (type: string): string => {
    switch (type) {
      ...
      case 'node_error': return 'Node Error';
      case 'quota_alert': return 'Quota Alert';
  ...
  return (
    <Card>
          ...
          <div className="w-full sm:w-auto">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="workflow_started">Workflow Started</SelectItem>
      ...
      <CardContent>
        {loading ? (
          <div className="flex justify-center p-8">Loading notification logs...</div>
        ) : logs.length === 0 ? (
                        ...
                        {log.status === 'failed' && log.error_message ? (
                          ...
                          <span className="text-sm text-muted-foreground">
                            {log.content && typeof log.content === 'object'
                              ? log.content.title || log.content.subject || 'Notification sent'
                              : 'Notification sent'}
                          </span>
                        )}
                      </TableCell>
