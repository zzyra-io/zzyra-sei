...
class ExecutionService {
  ...
  async retryExecution(executionId: string, nodeId?: string): Promise<ExecutionResult> {
    try {
  ...
  async cancelExecution(executionId: string, nodeId?: string): Promise<ExecutionResult> {
    try {
  ...
  async pauseExecution(executionId: string, nodeId?: string): Promise<ExecutionResult> {
    try {
  ...
  async resumeExecution(executionId: string, nodeId?: string): Promise<ExecutionResult> {
    try {
