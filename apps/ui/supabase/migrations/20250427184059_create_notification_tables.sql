...
VALUES 
  ...
  ('workflow_started', 'telegram', '', 'Zzyra Alert: Your workflow "{{workflow_name}}" has started execution.'),
  ('workflow_completed', 'telegram', '', 'Zzyra Alert: Your workflow "{{workflow_name}}" has completed successfully.'),
  ('workflow_failed', 'telegram', '', 'Zzyra Alert: Your workflow "{{workflow_name}}" has failed. Error: {{error_message}}'),
  ('node_error', 'telegram', '', 'Zzyra Alert: A node in your workflow "{{workflow_name}}" has encountered an error. Node: {{node_name}}. Error: {{error_message}}'),
  ('quota_alert', 'telegram', '', 'Zzyra Alert: You have used {{used_executions}} out of your {{total_executions}} monthly workflow executions.'),
