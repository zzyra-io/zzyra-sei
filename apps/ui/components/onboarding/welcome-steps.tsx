...
const steps: StepProps[] = [
  {
    ...
    description: "Your all-in-one platform for building powerful Web3 automation workflows with no-code required.",
    icon: <Zap className="h-12 w-12 text-primary" />,
  },
  {
    title: "Build Custom Workflows",
    description: "Drag and drop blocks to create custom workflows that automate your Web3 operations.",
    icon: <Layers className="h-12 w-12 text-primary" />,
  },
  {
    title: "Connect Your Wallet",
    description: "Securely connect your wallet to interact with blockchain features and automate transactions.",
      ...
      <CardContent className="px-8 py-6">
        <AnimatePresence mode="wait">
          {!completed ? (
            ...
            >
              <div className="mb-6 p-4 rounded-full bg-primary/10">{steps[currentStep].icon}</div>
            ...
            >
              ...
              <CardDescription className="text-base">
                You're ready to start building powerful automation workflows with Zyra.
              </CardDescription>
            </motion.div>
          )}
        </AnimatePresence>
