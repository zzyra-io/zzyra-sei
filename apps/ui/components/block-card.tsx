...
import {
  BlockCategoryBadge,
  BlockTypeBadge,
} from "@/components/ui/block-category-badge";
...
export function BlockCard({
  ...
  const category =
    block.category ||
    (block.blockType.startsWith("DEFI")
      ? NodeCategory.FINANCE
      : block.blockType.includes("CONDITION")
        ? NodeCategory.LOGIC
        : block.blockType.includes("SCHEDULE") ||
            block.blockType.includes("TRIGGER")
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-4 text-sm text-muted-foreground'>
              ...
              <Tooltip>
                ...
                <TooltipContent side='bottom'>
                  <p className='text-xs'>
                    Number of times this block has been used in workflows
                  </p>
                </TooltipContent>
              </Tooltip>
            </div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align='end' className='w-56'>
                  ...
                  <DropdownMenuItem
                    onClick={() => {
                      router.push(
                        `/docs/blocks/${block.blockType.toLowerCase()}`
                      );
                    }}>
