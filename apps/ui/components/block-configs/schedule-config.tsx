  ...
  return (
    <div className="p-4 space-y-4">
      <div className="space-y-2">
        ...
        <Select value={config.interval || "hourly"} onValueChange={(value) => handleChange("interval", value)}>
      ...
      {config.interval === "weekly" && (
        <>
          <div className="space-y-2">
            ...
            <Select value={config.dayOfWeek || "1"} onValueChange={(value) => handleChange("dayOfWeek", value)}>
