  ...
  return (
    <div className="p-4 space-y-6">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground">
              Leave empty or use "native" for {selectedChain?.symbol || "native token"}
            </div>
          </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleChange("deadline", parseInt(e.target.value) || 20)}
            />
            <div className="text-sm text-muted-foreground">
      ...
      <Alert>
        ...
        <AlertDescription>
          Token swaps involve financial risk. Always verify token addresses and amounts.
          This operation requires blockchain authorization with appropriate spending limits.
        </AlertDescription>
      </Alert>
      ...
      <Alert>
        ...
        <AlertDescription>
          Swapping will be executed on the selected DEX platform. 
          Slippage protection ensures you don't receive less than the minimum amount specified.
        </AlertDescription>
      </Alert>
