    ...
    <div className='p-4 space-y-6'>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='text-sm text-muted-foreground'>
            Store wallet address and metadata for future use. Private keys are
            never stored.
          </div>
        </CardContent>
      </Card>
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Security Notice:</strong> Private keys are generated securely
          and never stored. Make sure to backup the generated wallet address and
          private key immediately after creation.
        </AlertDescription>
      </Alert>
      ...
      <Alert>
        ...
        <AlertDescription>
          This block creates a new blockchain wallet with a unique address and
          private key. Use for automated workflows that need dedicated wallet
          addresses.
        </AlertDescription>
      </Alert>
