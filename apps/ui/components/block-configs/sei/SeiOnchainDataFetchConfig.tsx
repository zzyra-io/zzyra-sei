        ...
        <TabsContent value="config" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure data fetching parameters</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="defi_positions">DeFi Positions</SelectItem>
                      <SelectItem value="tx_history">Transaction History</SelectItem>
                      <SelectItem value="contract_state">Contract State</SelectItem>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateConfig({ targetAddress: e.target.value })}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateConfig({ cacheTtl: parseInt(e.target.value) || 60000 })}
                />
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="inputs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Dynamic inputs from previous blocks</CardDescription>
            </CardHeader>
            <CardContent>
