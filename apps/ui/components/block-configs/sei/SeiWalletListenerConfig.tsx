...
import { z } from 'zod';
import { seiWalletListenerSchema, type SeiWalletListenerConfig } from '@zyra/types';
...
export default function SeiWalletListenerConfig({
  ...
  const typedConfig: SeiWalletListenerConfig = {
    network: 'sei-testnet',
    walletAddresses: [],
    eventTypes: [],
  ...
  const updateConfig = useCallback(
    (updates: Partial<SeiWalletListenerConfig>) => {
  ...
  const addWalletAddress = () => {
    const newAddresses = [...typedConfig.walletAddresses, ''];
    updateConfig({ walletAddresses: newAddresses });
  };

  const removeWalletAddress = (index: number) => {
    const newAddresses = typedConfig.walletAddresses.filter((_, i) => i !== index);
    updateConfig({ walletAddresses: newAddresses });
  };
  ...
  const toggleEventType = (eventType: string) => {
    const newEventTypes = typedConfig.eventTypes.includes(eventType as any)
      ? typedConfig.eventTypes.filter(type => type !== eventType)
      : [...typedConfig.eventTypes, eventType as any];
        ...
        <TabsContent value="config" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select the Sei network to monitor</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                {validationErrors.network && (
                  <p className="text-sm text-red-500 mt-1">{validationErrors.network}</p>
                )}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add Sei wallet addresses to monitor (max 10)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {validationErrors.walletAddresses && (
                <p className="text-sm text-red-500">{validationErrors.walletAddresses}</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select which blockchain events to monitor</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={value} className="flex items-center space-x-2">
                    <Checkbox
                      id={value}
                      checked={typedConfig.eventTypes.includes(value as any)}
              ...
              {validationErrors.eventTypes && (
                <p className="text-sm text-red-500">{validationErrors.eventTypes}</p>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig({ pollingInterval: parseInt(e.target.value) || 30000 })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateConfig({ maxEventsPerPoll: parseInt(e.target.value) || 50 })}
                  />
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateConfig({ includeRawEvents: !!checked })}
                />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add filters to narrow down events</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    placeholder="0"
                    value={typedConfig.filters?.minAmount || ''}
                ...
                <div>
                  ...
                  <Input
                    id="tokenDenom"
                    placeholder="usei"
                    value={typedConfig.filters?.tokenDenom || ''}
                    onChange={(e) => updateConfig({
                      filters: {
                        ...typedConfig.filters,
        ...
        <TabsContent value="inputs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>This block accepts standard workflow inputs</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="outputs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>This block outputs detected wallet events</CardDescription>
            </CardHeader>
            <CardContent>
              <pre className="bg-gray-100 p-4 rounded text-sm">
{`{
        ...
        <TabsContent value="execution" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor block execution and test configuration</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {executionData?.error && (
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-600">{executionData?.startTime || 'Not started'}</p>
                </div>
                <div>
