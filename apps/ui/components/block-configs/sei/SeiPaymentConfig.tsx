  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Payments will be executed on the blockchain and may incur fees. Always verify recipient addresses.
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="config" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure payment details and recipients</CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => updateConfig({ paymentType: value })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => updateConfig({
                        singlePayment: { ...typedConfig.singlePayment, recipient: e.target.value }
                      })}
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig({
                          singlePayment: { ...typedConfig.singlePayment, amount: parseFloat(e.target.value) || 0 }
                        })}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig({
                          singlePayment: { ...typedConfig.singlePayment, tokenDenom: e.target.value }
                        })}
                      />
                    </div>
                  </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select wallet for signing transactions</CardDescription>
            </CardHeader>
            <CardContent>
              <Select
