      ...
      <div className='flex min-h-screen flex-col items-center justify-center bg-muted/30 px-4 py-8'>
        <div className='mx-auto w-full max-w-md'>
          <div className='mb-8 text-center'>
            <h1 className='text-2xl font-bold'>Welcome to Zzyra</h1>
          ...
          {step === 2 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Help us understand how you plan to use Zzyra
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  ...
                  <Select value={useCase} onValueChange={setUseCase}>
                    ...
                    <SelectContent>
                      <SelectItem value='defi_automation'>
                        DeFi Automation
                      </SelectItem>
                      <SelectItem value='wallet_monitoring'>
                        Wallet Monitoring
                      </SelectItem>
                      <SelectItem value='nft_trading'>NFT Trading</SelectItem>
                      <SelectItem value='dao_operations'>
                        DAO Operations
                      </SelectItem>
                      <SelectItem value='portfolio_management'>
                ...
                <div className='space-y-2'>
                  ...
                  <Textarea
                    ...
                    placeholder='What are you hoping to achieve with Zzyra?'
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Receive email notifications about workflow executions,
