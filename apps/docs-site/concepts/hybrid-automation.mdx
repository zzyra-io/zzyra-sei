...
description: "Bridging Web2 and Web3 systems through intelligent workflow orchestration - Development Vision"
---

<Alert type="info">
  **Development Vision**: This document outlines Zzyra's planned approach to hybrid automation. Many features described here are part of our development roadmap.
</Alert>

## What is Hybrid Automation?

Hybrid automation refers to the orchestration of workflows that span both traditional Web2 enterprise systems and Web3 decentralized protocols. This approach creates bridges between previously disconnected ecosystems.

<Info>
  **Vision**: Zzyra is being designed to enable organizations to leverage both enterprise system stability and blockchain innovation through unified automation workflows.
</Info>
...
Zzyra's planned hybrid approach aims to unlock new possibilities:
...
<Alert type="warning">
  **Development Roadmap**: The patterns described below represent planned functionality as part of Zzyra's development roadmap.
</Alert>

### 1. Data Synchronization (Planned)

Vision for keeping information consistent across Web2 and Web3 systems:
