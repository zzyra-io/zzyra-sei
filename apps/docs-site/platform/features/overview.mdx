...
<Alert type="info">
  **Development Status**: Zzyra is in active development with core AI and blockchain capabilities implemented. This overview covers both current features and planned enhancements.
</Alert>
...
<Tabs>
  ...
  <Tab title="Security Framework">
    **Multi-Layer Security**
    - OAuth 2.0 with Magic SDK authentication
...
<Tabs>
  <Tab title="APIs & SDKs">
    **Comprehensive Developer Tools**
    ...
    const execution = await zyra.workflows.execute(workflow.id);
    ```
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Quick Start Guide" icon="rocket" href="/quickstart">
    Get up and running with Zyra in minutes
  </Card>
  
  <Card title="AI Agents Guide" icon="brain" href="/platform/ai-agents/overview">
  ...
  <Card title="Session Keys Security" icon="key" href="/platform/security/session-keys">
    Understand the session key system and account abstraction
  </Card>
  
  <Card title="Template Library" icon="template" href="/platform/templates/overview">
