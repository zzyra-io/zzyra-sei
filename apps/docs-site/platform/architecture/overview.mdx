...
<div className='monorepo-structure'>
  ...
  <div className='structure-tree'>
    ...
    <div className='tree-branch'>
      ...
      <div className='branch-items'>
        <div className='tree-item'>✅ @zzyra/database - Prisma Client & Repositories</div>
        <div className='tree-item'>✅ @zzyra/types - Shared TypeScript Types</div>
        <div className='tree-item'>📋 @zzyra/blocks - Block Library (Planned)</div>
      </div>
    </div>
