...
description: "Zyra's production-ready hybrid automation platform architecture - monorepo with Next.js, NestJS, and PostgreSQL"
---
...
<Alert type='info'>
  **Production Status**: All core services are production-ready with advanced AI capabilities, session key system, and multi-chain blockchain support.
  **Technology Stack**: Next.js 15 + NestJS 10 + PostgreSQL + Prisma + Advanced AI/Blockchain Integration
</Alert>
...
<div className='arch-layer'>
  ...
  <div className='layer-components'>
    <div className='component'>
      ...
      <span className='component-desc'>✅ Production - REST APIs & Session Keys</span>
    </div>
    <div className='component'>
      <span className='component-icon'>⚙️</span>
      <span className='component-name'>NestJS Worker</span>
      <span className='component-desc'>✅ Production - AI Agents & Blockchain</span>
    </div>
    <div className='component'>
      <span className='component-icon'>🤖</span>
      <span className='component-name'>AI Engine</span>
      <span className='component-desc'>✅ Production - MCP Servers & Multi-LLM</span>
    </div>
  </div>
</div>
