...
Zzyra is built as a modern, scalable monorepo with three core components working together to deliver seamless hybrid automation. Our architecture prioritizes performance, reliability, and developer experience while supporting both Web3 and traditional enterprise integrations.

<Alert type='info'>
  **Technology Stack**: Next.js 15 + NestJS 10 + PostgreSQL + Prisma + RabbitMQ
...
<div className='arch-layer'>
  ...
  <div className='layer-components'>
    <div className='component'>
      ...
      <span className='component-desc'>RESTful API + Authentication</span>
    </div>
    <div className='component'>
      <span className='component-icon'>⚙️</span>
      <span className='component-name'>NestJS Worker</span>
      <span className='component-desc'>Async Processing + AI</span>
    </div>
    <div className='component'>
      <span className='component-icon'>📨</span>
      <span className='component-name'>RabbitMQ</span>
      <span className='component-desc'>Message Queue</span>
    </div>
  </div>
</div>
  ...
  <div className='arch-layer'>
    ...
    <div className='layer-components'>
      ...
      <div className='component'>
        ...
        <span className='component-desc'>Database Client</span>
      </div>
      <div className='component'>
        <span className='component-icon'>📦</span>
  ...
  <div className='structure-tree'>
    ...
    <div className='tree-branch'>
      <div className='branch-header'>
        ...
        <span className='branch-desc'>NestJS API Server</span>
      </div>
      <div className='branch-items'>
    ...
    <div className='tree-branch'>
      ...
      <div className='branch-items'>
        <div className='tree-item'>@zzyra/database - Prisma Client</div>
        <div className='tree-item'>@zzyra/types - TypeScript Types</div>
        <div className='tree-item'>@zzyra/blocks - Block Library</div>
      </div>
    </div>
