...
description: "Zzyra's hybrid automation platform architecture - monorepo with Next.js, NestJS, and PostgreSQL"
---

## Architecture Overview

Zzyra is built as a modern, scalable monorepo with two active services and one in development, designed to deliver hybrid Web2/Web3 automation. Our architecture prioritizes developer experience and rapid iteration while building towards production scalability.

<Alert type='warning'>
  **Current Status**: Frontend and Worker services are active. API service is in development. 
  **Technology Stack**: Next.js 15 + NestJS 10 + PostgreSQL + Prisma
</Alert>
...
<div className='arch-layer'>
  ...
  <div className='layer-components'>
    <div className='component'>
      ...
      <span className='component-desc'>🚧 In Development</span>
    </div>
    <div className='component'>
      <span className='component-icon'>⚙️</span>
      <span className='component-name'>NestJS Worker</span>
      <span className='component-desc'>✅ Active - Workflow Processing</span>
    </div>
    <div className='component'>
      <span className='component-icon'>📨</span>
      <span className='component-name'>Message Queue</span>
      <span className='component-desc'>📋 Planned - RabbitMQ</span>
    </div>
  </div>
</div>
  ...
  <div className='arch-layer'>
    ...
    <div className='layer-components'>
      ...
      <div className='component'>
        ...
        <span className='component-desc'>✅ Primary Database Client</span>
      </div>
      <div className='component'>
        <span className='component-icon'>📦</span>
        <span className='component-name'>Shared Packages</span>
        <span className='component-desc'>✅ Types + Database + Blocks</span>
      </div>
    </div>
  </div>
</div>
  ...
  <div className='structure-tree'>
    ...
    <div className='tree-branch'>
      <div className='branch-header'>
        ...
        <span className='branch-desc'>🚧 NestJS API Server (In Development)</span>
      </div>
      <div className='branch-items'>
    ...
    <div className='tree-branch'>
      <div className='branch-header'>
        ...
        <span className='branch-name'>apps/zyra-worker/</span>
        <span className='branch-desc'>✅ NestJS Worker Service</span>
      </div>
      <div className='branch-items'>
    ...
    <div className='tree-branch'>
      ...
      <div className='branch-items'>
        <div className='tree-item'>✅ @zyra/database - Prisma Client & Repositories</div>
        <div className='tree-item'>✅ @zyra/types - Shared TypeScript Types</div>
        <div className='tree-item'>📋 @zyra/blocks - Block Library (Planned)</div>
      </div>
    </div>
...
<div className='database-schema'>
  <div className='schema-overview'>
    <h3>🗄️ PostgreSQL with Prisma ORM</h3>
