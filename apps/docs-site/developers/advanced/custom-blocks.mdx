...
description: "Guide for building custom automation blocks for Zzyra - Development Status"
---

## Building Custom Blocks

<Alert type='warning'>
  **Development Status**: Custom block creation system is in development. Basic AI-assisted block generation is available.
</Alert>
...
<Alert type='info'>
  **Development Example**: This shows the planned approach for custom block creation.
</Alert>
