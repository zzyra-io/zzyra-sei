import { getWalletMode } from '../config';
import { DisabledWalletProvider } from './providers/disabled';
import { PrivateKeyWalletProvider } from './providers/private-key';
...
export * from './types';
export { PrivateKeyWalletProvider } from './providers/private-key';
export { DisabledWalletProvider } from './providers/disabled';
