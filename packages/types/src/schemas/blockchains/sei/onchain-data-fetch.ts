...
export const seiOnchainDataFetchSchema: EnhancedBlockSchema = {
  configSchema: z.object({
    ...
    txConfig: z.object({
      txType: z.enum(['send', 'receive', 'contract', 'delegate', 'all']).default('all'),
  ...
  outputSchema: z.object({
    ...
    defiPositions: z.array(z.object({
      protocol: z.string(),
  ...
  metadata: {
    ...
    icon: 'database',
    description: 'Fetch comprehensive onchain data from Sei blockchain including balances, NFTs, and transaction history',
    tags: ['sei', 'data', 'fetch', 'blockchain', 'query', 'balance', 'nft', 'defi'],
  },
};

export type SeiOnchainDataFetchConfig = z.infer<typeof seiOnchainDataFetchSchema.configSchema>;
export type SeiOnchainDataFetchInput = z.infer<typeof seiOnchainDataFetchSchema.inputSchema>;
export type SeiOnchainDataFetchOutput = z.infer<typeof seiOnchainDataFetchSchema.outputSchema>;